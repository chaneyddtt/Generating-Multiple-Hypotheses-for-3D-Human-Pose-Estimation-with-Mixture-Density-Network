...
![Problem illustration](probem_illustration.png)
...
```
python predict_3dpose_mdm.py --test True --load 4338038 --load_dir ../Models/mdm_5_prior/ (model with dirichlet prior)
```
or run:
```
python predict_3dpose_mdm.py --test True --load 4679232 --load_dir ../Models/mdm_5/ (for the CMU dataset)
```
**Visualize**
